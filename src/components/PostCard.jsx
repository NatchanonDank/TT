...
const PostCard = ({
  ...
  const [internalLikedPosts, setInternalLikedPosts] = useState(new Set());

  // ✅ Use parent props if available, otherwise use internal state
  ...
  // ✅ เพิ่มฟังก์ชันแก้ไขภายใน
  const internalHandleOpenEditModal = (post) => {
  ...
  // ✅ Use parent handlers if available, otherwise use internal
      ...
      <div className="post-card">
                ...
                <div key={idx} className="request-item">
                  ...
                  <div className="request-info">
                    ...
                    <span className="request-time">
                      ขอเมื่อ: {new Date(request.requestedAt).toLocaleTimeString('th-TH', {
                        hour: '2-digit', 
                        minute: '2-digit'
                      })}
                    </span>
        ...
        <div className="post-actions">
          ...
          >
            <Heart 
              size={20} 
              fill={isLiked ? "#f5533d" : "none"} 
              color={isLiked ? "#f5533d" : "currentColor"} 
            />
